...
public class Hållbarhetsmål extends javax.swing.JFrame {
     ...
     */
    public Hållbarhetsmål(Meny meny) {
        initComponents();
        this.meny = meny;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sdg/admin/Images/800x500.jpg"))); // NOI18N
    ...
    private void TillbakaTillMenyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TillbakaTillMenyActionPerformed
        ...
        meny.setLocationRelativeTo(null); // centrerar fönstret
        this.dispose();
